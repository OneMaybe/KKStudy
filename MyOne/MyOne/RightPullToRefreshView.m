...
- (void)setUpViews {
    ...
    self.carousel.bounceDistance = 0.7;   //弹跳距离
    self.carousel.decelerationRate = 0.6; //减速的速度
    ...
    [self.leftRefreshLabel setNeedsDisplay]; //方便绘图，一般在sizeToFit后调用
