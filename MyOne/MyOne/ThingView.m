...
@property (nonatomic, strong) KKImageView *thingImageView;
...
- (void)setUpViews {
	...
	// 初始化东西图片控件
	self.thingImageView = [[KKImageView alloc] init];
...
- (void)configureViewWithThingEntity:(ThingEntity *)thingEntity animated:(BOOL)animated {
	...
	[self.thingImageView configImageViewWithUrl:[NSURL URLWithString:thingEntity.strBu] animated:animated];
